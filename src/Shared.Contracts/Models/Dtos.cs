...
public class ReconResult
{
    ...
    public ReconResult() { }
    public ReconResult(bool success, DateTimeOffset at, double averagedValue, string message)
    {
        Success = success; At = at; AveragedValue = averagedValue; Message = message;
    }
}
